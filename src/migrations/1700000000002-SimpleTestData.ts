...
export class SimpleTestData1700000000002 implements MigrationInterface {
  name = 'SimpleTestData1700000000002';
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      ('f2g3h4i5-j6k7-48l9-m0n1-p2q3r4s5t6u7', '${this.userId}'::uuid, '15.25', 'Coffee with friends', '2023-10-16 14:30:00', '2023-10-16 14:30:00', '2023-10-16 14:30:00'),
      ('g3h4i5j6-k7l8-49m0-n1o2-p3q4r5s6t7u8', '${this.userId}'::uuid, '45.75', 'Restaurant dinner', '2023-10-17 19:00:00', '2023-10-17 19:00:00', '2023-10-17 19:00:00')
      ON CONFLICT (id) DO NOTHING;
    `);
  }
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DELETE FROM "expense_entity" WHERE id IN (
        ...
        'f2g3h4i5-j6k7-48l9-m0n1-p2q3r4s5t6u7',
        'g3h4i5j6-k7l8-49m0-n1o2-p3q4r5s6t7u8'
      );
    `);
